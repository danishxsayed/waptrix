...
<head>
    ...
    <style>
        ...
        .logo { background-color: #264C39; color: #080A0F; padding: 12px; border-radius: 12px; font-weight: bold; font-size: 24px; display: inline-block; box-shadow: 0 0 20px rgba(38,76,57,0.3); }
        ...
        .button { display: inline-block; background-color: #264C39; color: #080A0F; padding: 16px 32px; border-radius: 12px; font-weight: bold; text-decoration: none; font-size: 16px; transition: all 0.2s; box-shadow: 0 0 15px rgba(38,76,57,0.2); }
...
<body>
    <div class="container">
        <div class="header">
            ...
            <h2 style="color: #264C39; margin-top: 20px; font-size: 20px;">Waptrix</h2>
        </div>
        <div class="content">
            <h1>${title}</h1>
            <p>${message}</p>
